...
import { Upload, BookOpen, Heart, Settings, PlayCircle, Loader, Trash2, LogOut } from 'lucide-react'; // Added LogOut
          ...
          <div className="bg-dark-surface p-6 rounded-3xl border border-gray-800 shadow-xl relative overflow-hidden">
            ...
            <div className="space-y-5">
              <div>
                ...
                <input type="text" placeholder="e.g. Midterm History" value={config.customTitle}
              ...
              <div>
                ...
                <input type="range" min="5" max="20" step="1" value={config.numQuestions}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select value={config.category} onChange={(e) => setConfig({...config, category: e.target.value})}
                    ...
                    <option>College</option><option>Senior High</option><option>High School</option>
                  </select>
                </div>
                <div>
                  <label className="text-xs font-bold text-gray-500 uppercase mb-1 block">Program</label>
                  <select value={config.program} onChange={(e) => setConfig({...config, program: e.target.value})}
                    className="w-full bg-gray-900 border border-gray-700 rounded-xl p-3 text-sm text-white focus:border-neon-purple outline-none">
                    <option>BSIT</option><option>Nursing</option><option>Engineering</option><option>Education</option>
                  </select>
                </div>
              </div>
            </div>
